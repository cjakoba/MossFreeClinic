            ...
            <div class="trainer-list-container;">
                ...
                <?php else: ?>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($associatedTrainerResult)): ?>
                        <li><a href='trainerprofile.php?username=<?php echo $row[' style='color: blue;'><?php echo $row['firstName'] . ' ' . $row['lastName']; ?></a></li>
                    <?php endwhile; ?>
                    </ul>
                <?php endif; ?>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;">
                                                <a href='trainerprofile.php?username=<?php echo $row[' style='color: blue;'><?php echo $row['firstName'] . ' ' . $row['lastName']; ?></a>
                                            </div>
                                        </td>
                                        <td>
