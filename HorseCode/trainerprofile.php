        ...
        <div class="horse-list-container">
            ...
            <?php else: ?>
                ...
                <?php while ($row = mysqli_fetch_assoc($associatedHorsesResult)): ?>
                    <li><a href='horseprofile.php?horseID=<?php echo $row[' style='color: blue;'><?php echo $row['horseName']; ?></a></li>
                <?php endwhile; ?>
                </ul>
            <?php endif; ?>
        </div>
                ...
                <?php else: ?>
                    <table class="notes-table">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result2)): ?>
                            <tr>
                                <td class="horse-name" ><a href='HorseCode/horseprofile.php?horseID=<?php echo $row[' style='color: blue;'><?php echo $row['horseName']; ?></a></td>
